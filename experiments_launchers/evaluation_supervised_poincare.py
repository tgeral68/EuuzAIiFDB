...
total_accuracy = evaluation.supervised_poincare_eval(representations, D.Y, n_centroid,  verbose=True)
print("Performances : ", total_accuracy)
log_xp.append({"supervised_evaluation":total_accuracy})
