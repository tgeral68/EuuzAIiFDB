...
CUDA_VISBLE_DEVICES=0 python3.7 experiments_launchers/experiment_poincare.py  --cuda  --batch-size 512 --dataset dblp  --n-centroid 5 --walk-lenght 60  --precompute-rw 6 --beta 1.  --alpha .5 --lr 25.  --negative-sampling 8  --context-size 10  --epoch 1000 --embedding-optimizer exphsgd   --id "dblp-2D" --size 2 --seed 120
